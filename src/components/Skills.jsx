      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col-4 col-sm-4 col-md-3 col-lg-2 text-center justsmmb">
            ...
            <p className="d-none d-sm-block">GIT</p>
          </div>
          <div className="col-4 col-sm-4 col-md-3 col-lg-2 text-center justsmmb">
            <img
              ...
              className="icon-size"
            />
            <p className="d-none d-sm-block">Slack</p>
          </div>
          <div className="col-4 col-sm-4 col-md-3 col-lg-2 text-center justsmmb">
            <img
              ...
              className="icon-size"
            />
            <p className="d-none d-sm-block">Scrum</p>
          </div>
          <div className="col-4 col-sm-4 col-md-3 col-lg-2 text-center justsmmb">
            <img
              ...
              className="icon-size"
            />
            <p className="d-none d-sm-block">Trello</p>
          </div>
          <div className="col-4 col-sm-4 col-md-3 col-lg-2 text-center justsmmb">
            <img
              ...
              className="icon-size"
            />
            <p className="d-none d-sm-block">Ingles</p>
          </div>
        </div>
      </div>
    </>
